...
export class OrderEvolver{
   ...
   static toModel(dto: OrderDto): OrderModel {
      ...
      var model: OrderModel = new OrderModel(dto.orderId, dto.customerId, orderStatusAsEnum, dto.timeCancelled, dto.timePayed, dto.timeDelivered, dto.orderProducts.map(OrderProductEvolver.toModel));
      return model;
   }
   ...
   static toDto(model: OrderModel): OrderDto {
      ...
      var dto: OrderDto = {
         ...
         timeCancelled: model.timeCancelled,
